...
| 📦 **Mclium** – Advanced Minecraft pentesting toolkit with raw protocol client, Java class injector, and deep server testing capabilities | ❌ | ![Python](https://skillicons.dev/icons?i=py) ![Java](https://skillicons.dev/icons?i=java) ![Go](https://skillicons.dev/icons?i=go) | 🧪 Active development | Private |
...
<p>
  <img src="https://skillicons.dev/icons?i=py,java,js,discord,html,css,sqlite,git" height="50" />
  <img src="https://skillicons.dev/icons?i=idea,pycharm,flask,vscode,vim,arch,ubuntu,kali" height="50" />
